...
const PROJECTS: Project[] = [
  {
    ...
    langColor:   '#659AD2',
    description: 'Custom OBJ parser - no asset-loading libraries, every vertex, normal, and face read by hand. Implements PBR shading, functional shadow mapping, and directional lighting on a fully custom shader pipeline. One of my first C++ projects; working this close to the metal taught me more about the graphics stack than any tutorial.',
    image:       './image1.png',
  ...
  },
  {
    ...
    tags:        ['Godot Engine', 'Game Jam', '2D Gameplay'],
    languages:   ['GDScript'],
    domain:      'Games',
    size:        'wide',
  },
  {
    ...
    langColor:   '#e07639',
    description: 'Procedural voxel world engine in Rust with a custom Vulkan renderer. Greedy meshing collapses geometry for minimal draw calls; chunk generation runs on a thread pool; distance fog hides unloaded geometry so the world appears infinite. Also includes biome-driven terrain and basic physics.',
